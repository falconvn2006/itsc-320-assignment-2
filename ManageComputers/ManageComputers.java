...
public class ManageComputers {
    ...
    // Whitelist values for valid input
    ...
    private static final String[] TYPE_WHITELIST = { "l", "d" };
    ...
    // -----------------------------
    // Check if a given input value exists in a whitelist
    private static boolean isInWhitelist(String input, String[] whitelist) {

        for (String allowedValue : whitelist) {
            if (allowedValue.equals(input)) {
                return true;
            }
        }
    ...
    } // End of isInWhitelist

    // -----------------------------
    // Get input from user and keep prompting until a valid whitelist value is
    // entered
    private static String getValidInput(Scanner s, String[] whitelist, boolean forceLowerCase, String errorMessage) {
        String input = "";
        ...
        do {
            ...
            if (!isInWhitelist(input, whitelist)) {
                System.out.println(errorMessage);
                System.out.print("Please re-enter value:");
            }

        } while (!isInWhitelist(input, whitelist));
